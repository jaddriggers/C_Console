...
//Chapter 20 Advanced math for your computer rand()
...
//	char ans;
//
//	//Needed to make sure that each random number is generated is different
//
//	srand(time_t(&t));
//
//	//this would give you a number between 1 and 5 so the +1 will give you 6
//
//	dice1 = (rand() % 5) + 1;
//	dice2 = (rand() % 5) + 1;
//	total1 = dice1 + dice2;
//	printf("First role of the dice was %d and %d. ", dice1, dice2);
//	printf("For a total of %d\n\n\n", total1);
//
//	do
//	{
//		puts("What do you think the next roll will be (H)igher, (L)ower, or (S)ame?\n");
...
//	dice2 = (rand() % 5) + 1;
//	total2 = dice1 + dice2;
//	printf("Second role of the dice was %d and %d. ", dice1, dice2);
//	printf("For a total of %d\n\n\n", total2);
//
//	//Conmpare the two roles against the user's guess and tell them if they were right.
//
//	//If user enters L
//	if (ans == 'L')
//	{
//		if (total2 < total1)
//		{
//			printf("Good job! You guessed correct!\n");
